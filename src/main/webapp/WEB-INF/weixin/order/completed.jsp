...
<body>
	<div class="box-positon">
		<div class="rpos">当前位置: 订单管理 - 已完成列表</div>
		<div class="clear"></div>
	</div>
	<div class="body-box">
		<form action="/order/completed.do" method="post"
			style="padding-top: 5px;">
			手机号: <input type="text" name="tel" value="${tel}" /> &nbsp&nbsp&nbsp
			时间区间：<input type="text" id="dp11" class="ui-time-text" name="time"
				value="${time}" kssj="" jssj="" /> <input id="opstyle" name="opstyle"
				type="hidden" value="2" /> <input type="submit" class="query"
				value="查询" />
		</form>
