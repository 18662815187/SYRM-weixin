                     ...
                     <div class="login-welcome">
                             <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <img src="images/admin/welconlogin-icon.png"/><span id="welcome">您好:${USER_NAME}!</span>
                                    <img src="images/admin/loginout-icon.png"/><a href="<%=basePath%>/logout.do" target="_top" id="logout" onclick="return confirm('您确定退出吗?');">退出</a> 
                     ...
                     <div class="nav">
                     	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                ...
                                <td>
                                	<ul class="nav-menu">
                                    	<li class="current" id="tb_11" onclick="HoverLi(11);"><a href="<%=basePath%>/main.do" target="mainFrame">首页</a></li>
										<li class="sep"></li><li class="normal" id="tb_12" onclick="HoverLi(12);"><a href="<%=basePath%>/frame/product_main.do" target="mainFrame">活动管理</a></li>
										<!-- 
										<li class="sep"></li><li class="normal" id="tb_13" onclick="HoverLi(13);"><a href="frame/order_main.do" target="mainFrame">订单</a></li>
										<li class="sep"></li><li class="normal" id="tb_14" onclick="HoverLi(14);"><a href="frame/report_main.do" target="mainFrame">报表</a></li> -->
