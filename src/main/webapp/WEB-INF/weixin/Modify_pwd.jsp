	...
	<form action="/modifyPwd/czPwd" method="post"
		...
		<div class="body">
			<table class="body_table">
				<tr>
					<td colspan="2"><span style="font-size: 30px;"> 修改密码 </span></td>
				</tr>
				<tr>
					<td width="80px"><span>手机号码：</span><input type="hidden" name="id" value="${pharmacy.id}" ></input>
					<input type="hidden" name="type" value="${pharmacy.type}"></input>
					<input type="hidden" name="type" value="${pharmacy.isDel}"></input>
					<input type="hidden" name="type" value="${pharmacy.isShow}"></input>
					</td>
					<td><input id="tel" name="tel" type="text"
						placeholder="输入手机号码" size="22" value="${pharmacy.tel}" readonly="readonly"/><span style="color: red">*</span>
				...
				<tr>
					<td colspan="2" style="padding: 10px;height="50px";text-align:center" ><div
						...
						<input id="sb" type="button" name="button" value="提交修改"
