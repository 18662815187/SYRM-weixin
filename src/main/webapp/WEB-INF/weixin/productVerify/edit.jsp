	...
	function uploadPic() {
		...
		var options = {
			...
			success : function(data) {
				...
				var html = '<tr>' + '<td width="20%" class="pn-flabel pn-flabel-h"></td>' + '<td width="80%" class="pn-fcontent">';
				for (var i = 0; i < data.length; i++) {
					html += '<img width="100" height="100" src="' + data[i] + '" />' + '<input type="hidden" name="images" value="' + data[i] + '"/>'
				}
				html += '<a href="javascript:;" class="pn-opt" onclick="jQuery(this).parents(\'tr\').remove()">删除</a>' + '</td>' + '</tr>';
				//回显
				$("#tab_2").append(html);
...
<body>
	...
	<div class="body-box" style="float: right">
		<form id="jvForm" action="/Pvc/saveOrUpdate" method="post" enctype="multipart/form-data">
			<table cellspacing="1" cellpadding="2" width="100%" border="0"
				...
				<input type="hidden" name="id" value="${product.id}"/>
					<tr>
						...
						<td width="80%" class="pn-fcontent"><input type="text"
							class="required" name="productName" maxlength="100" size="100" value="${product.productName}"/></td>
					</tr>
					<tr>
						<td width="20%" class="pn-flabel pn-flabel-h"><span
					...
					<tr>
						...
						<td width="80%" class="pn-fcontent">
						<input type="text" class="required" name="brandName" value="${product.brandName}" maxlength="100" size="20" /></td>
					</tr>
					<tr>
						<td width="20%" class="pn-flabel pn-flabel-h"><span
							class="pn-frequired">*</span>产品规格:</td>
						<td width="80%" class="pn-fcontent"><input type="text" name="spec"
							class="required" name="spec" maxlength="100" size="100" value="${product.spec}" /></td>
					</tr>
					<tr>
						<td width="20%" class="pn-flabel pn-flabel-h"><span
							class="pn-frequired">*</span> 生产厂家:</td>
						<td width="80%" class="pn-fcontent">
						<input type="text" class="required" name="factoryName" maxlength="100" size="50" value="${product.factoryName}"/>
						</td>
					</tr>
					<tr>
						<td width="20%" class="pn-flabel pn-flabel-h"><span
							class="pn-frequired">*</span> 库存:</td>
						<td width="80%" class="pn-fcontent"><input type="text" class="required" name="stock" maxlength="100" size="5" value="${product.stock}"/></td>
					</tr>
					<tr>
						<td width="20%" class="pn-flabel pn-flabel-h"><span
							class="pn-frequired">*</span>售价:</td>
						<td width="80%" class="pn-fcontent"><input type="text" class="required" name="price" maxlength="100" size="5" value="${product.price}"/></td>
					</tr>
				</tbody>
				<tbody id="tab_2" style="display: none">
					...
					<tr id="tt"><td width="20%" class="pn-flabel pn-flabel-h"></td><td width="80%" class="pn-fcontent">
					<c:forEach items="${product.pics}" var="pic">
					<img width="100" height="100" src="${pic}" />
					</c:forEach>
					<c:if test="${!empty product.pics}">
					<a href="javascript:;" class="pn-opt" onclick="remove()">删除</a></c:if></td></tr>
				</tbody>
				<tbody id="tab_3" style="display: none">
					<tr>
						<td><textarea rows="20" cols="180" id="productdesc"
								name="content" >${product.content}</textarea></td>
					</tr>
				</tbody>
				<tbody>
					<tr>
					...
					<tr>
						<td class="pn-fbutton" colspan="2"><input type="button" class="submit" onclick="submitPd()" value="提交" /> &nbsp; <input type="reset"
